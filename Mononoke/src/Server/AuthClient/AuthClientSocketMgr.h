...
#ifndef __AUTHCLIENTSOCKETMGR_H
#define __AUTHCLIENTSOCKETMGR_H
...
class AuthClientSocketMgr : public SocketMgr<XSocket>
{
        typedef SocketMgr<XSocket> BaseSocketMgr;

    public:
        ~AuthClientSocketMgr() = default;
...
#define sACSocketMgr AuthClientSocketMgr::Instance()
