...
CREATE TABLE IF NOT EXISTS `Character` (
  ...
  `immoral_point` decimal(18,4) NOT NULL DEFAULT '0.0',
  ...
  `flag_list` varchar(1000) NOT NULL DEFAULT '',
  `client_info` varchar(4096) NOT NULL DEFAULT '',
  `job_depth` tinyint(3) unsigned NOT NULL DEFAULT '0',
  ...
  `guild_block_time` bigint(20) NOT NULL DEFAULT '0',
  `pkmode` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `otp_value` int(11) NOT NULL DEFAULT '0',
  `otp_date` datetime NOT NULL DEFAULT NOW(),
