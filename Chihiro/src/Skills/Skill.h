...
public:
    ...
    static void DB_InsertSkill(Unit *pUnit, int64_t skillUID, int32_t skill_id, int32_t skill_level, int32_t cool_time);
    // skills
...
protected:
    void assembleMessage(TS_SC_SKILL &pSkillPct, int32_t nType, int32_t cost_hp, int32_t cost_mp);
    void Init();
