...
enum ItemCode {
    ...
    ITEM_CODE_BEGINNERS_BAG = 490001,
    ITEM_CODE_STAMINA_SAVER = 900000,
    ITEM_CODE_STAMINA_SAVER_NOT_FOR_SALE = 900010,
    ITEM_CODE_STAMINA_SAVER_FOR_NOVICE = 900011,
    ITEM_CODE_STAMINA_SAVER_OF_LOVE = 2000203,
    ITEM_CODE_FAIRY_POTION = 910004,
    ITEM_CODE_GRAND_FAIRY_POTION = 910005,
    ITEM_CODE_GRAND_FAIRY_POTION_BY_PLAYPOINT = 2902042,
    ITEM_CODE_GRAND_FAIRY_POTION_NOT_FOR_SALE = 2010454,
    ITEM_CODE_RETURN_FEATHER = 910006,
    ITEM_CODE_RETURN_BACK_FEATHER = 910009,
    ITEM_CODE_EVENT_RETURN_FEATHER = 2902104,
    ITEM_CODE_RUPPI_RETURN_FEATHER = 9000098,
    ITEM_CODE_FAIRY_LOCK = 920005,
    ITEM_CODE_SECROUTE_WARP_TICKET = 910023,
    ITEM_CODE_HUNTAHOLIC_POINT_TICKET = 806808,
    ITEM_CODE_RENAME_CHARACTER_TYPE1 = 930040,
    ITEM_CODE_RENAME_CHARACTER_TYPE2 = 930042,
    ITEM_CODE_RENAME_CHARACTER_TYPE3 = 2010459,
    ITEM_CODE_MIRROR_OF_TAMING_CARD = 960019,
    ITEM_CODE_MIRROR_OF_TAMING_CARD_TRADABLE = 960021,
    ITEM_CODE_MIRROR_OF_TAMING_CARD_ON_TEST = 9000111,
    ITEM_CODE_INGAME_POINT = 806809,
    ITEM_CODE_JOKER = 540070,
    ITEM_CODE_CHALK_OF_RESTORATION = 800000,
    ITEM_CODE_UNIT_CARD = 800001,
    ITEM_CODE_FEATHER_OF_RETURN = 910006,
    ITEM_CODE_FEATHER_OF_REINSTATEMENT = 910009,
    ITEM_CODE_E_REPAIR_POWDER = 950021,
    ITEM_CODE_FEATHER_OF_RETURN_EVENT = 2902104
};
...
struct ItemTemplate {
    ...
    int16_t base_type[4];
    float_t base_var[4][2];
    int16_t opt_type[4];
    float_t opt_var[4][2];
    int16_t enhance_id[2];
    float_t _enhance[2][4];
    int32_t skill_id;
    int32_t state_id;
    int32_t state_level;
    int32_t state_time;
