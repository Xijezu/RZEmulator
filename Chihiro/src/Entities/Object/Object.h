...
enum EPlayerFields
{
    ...
    PLAYER_FIELD_TRADE_GOLD          = BATTLE_FIELD_END + 0x0041, // Size: 1
    PLAYER_FIELD_WEIGHT              = BATTLE_FIELD_END + 0x0042, // Size: 1
    PLAYER_FIELD_RIDING_UID          = BATTLE_FIELD_END + 0x0043, // Size: 1
    PLAYER_END                       = BATTLE_FIELD_END + 0x0044
};
