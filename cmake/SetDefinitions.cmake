...
if(WIN32)
    ...
    elseif(MINGW)
        if(NOT DEBUG)
            ...
            set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -W -Wall -Wextra -Winit-self -Wsign-compare -Winvalid-pch -Wfatal-errors -g3")
            set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -W -Wall -Wextra -Winit-self -Wsign-compare -Winvalid-pch -Wfatal-errors -Woverloaded-virtual -g3")
        endif()
    endif()
elseif(UNIX)
   ...
   if(CMAKE_C_COMPILER MATCHES "gcc" OR CMAKE_C_COMPILER_ID STREQUAL "GNU")
    ...
    elseif(CMAKE_C_COMPILER MATCHES "clang" OR CMAKE_C_COMPILER_ID STREQUAL "Clang")
        if(DEBUG)
            set(WARNING_FLAGS "-W -Wall -Wextra -Winit-self -Wsign-compare -Wfatal-errors")
