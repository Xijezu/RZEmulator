...
# Set C++ Version: earliest supported is std=c++17
set(CPP_VERSION "std=c++2a") 
...
elseif(UNIX)
    ...
    elseif(CMAKE_C_COMPILER MATCHES "clang" OR CMAKE_C_COMPILER_ID STREQUAL "Clang")
        if(DEBUG)
            set(WARNING_FLAGS "-W -Wall -Wextra -Winit-self -Wfatal-errors -Wno-unused-variable -Wno-unused-parameter")
        ...
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -${CPP_VERSION} -Wno-narrowing -Wno-ignored-attributes -Wno-deprecated-declarations")
    endif()
endif()