...
#define WPAssert(cond, ...)                                                          \
    ...
    {                                                                                \
        if (!(cond))                                                                 \
            NGemity::Assert(__FILE__, __LINE__, __FUNCTION__, #cond, ##__VA_ARGS__); \
    }                                                                                \
    while (0)                                                                        \
    ASSERT_END
#define WPFatal(cond, ...)                                                   \
    ...
    {                                                                        \
        if (!(cond))                                                         \
            NGemity::Fatal(__FILE__, __LINE__, __FUNCTION__, ##__VA_ARGS__); \
    }                                                                        \
    while (0)                                                                \
    ASSERT_END
#define WPError(cond, msg)                                           \
    ...
    {                                                                \
        if (!(cond))                                                 \
            NGemity::Error(__FILE__, __LINE__, __FUNCTION__, (msg)); \
    }                                                                \
    while (0)                                                        \
    ASSERT_END
#define WPWarning(cond, msg)                                           \
    ...
    {                                                                  \
        if (!(cond))                                                   \
            NGemity::Warning(__FILE__, __LINE__, __FUNCTION__, (msg)); \
    }                                                                  \
    while (0)                                                          \
    ASSERT_END
#define WPAbort()                                         \
