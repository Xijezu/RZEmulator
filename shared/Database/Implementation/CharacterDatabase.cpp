...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHARACTER_GET_SUMMONLIST, "SELECT sid, account_id, code, card_uid, exp, jp, last_decreased_exp, name, transform, lv, jlv, max_level, fp, prev_level_01, prev_level_02, prev_id_01, prev_id_02, sp, hp, mp FROM Summon WHERE owner_id = ? AND account_id = 0", CONNECTION_SYNCH);
    PrepareStatement(CHARACTER_GET_STORAGE_SUMMONLIST, "SELECT sid, account_id, code, card_uid, exp, jp, last_decreased_exp, name, transform, lv, jlv, max_level, fp, prev_level_01, prev_level_02, prev_id_01, prev_id_02, sp, hp, mp FROM Summon WHERE owner_id = 0 AND account_id = ?", CONNECTION_SYNCH);
