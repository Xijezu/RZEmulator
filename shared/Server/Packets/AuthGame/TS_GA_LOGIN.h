...
#define TS_GA_LOGIN_DEF(_) \
    _(simple)(uint16_t, server_idx) _(string)(server_name, 21) _(string)(server_screenshot_url, 256) _(simple)(uint8_t, is_adult_server) _(string)(server_ip, 16) _(simple)(int32_t, server_port)
