...
#define TS_SC_DIALOG_DEF(_)                                                                                                                                                          \
    _(simple)                                                                                                                                                                        \
    (int32_t, type) _(simple)(uint32_t, npc_handle) _(count)(uint16_t, title) _(count)(uint16_t, text) _(count)(uint16_t, menu) _(dynstring)(title, false) _(dynstring)(text, false) \
