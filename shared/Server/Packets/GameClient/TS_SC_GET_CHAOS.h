...
#define TS_SC_GET_CHAOS_DEF(_)                                                                                                                                                           \
    _(simple)                                                                                                                                                                            \
    (uint32_t, hPlayer) _(simple)(uint32_t, hCorpse) _(simple)(int32_t, nChaos) _(simple)(int8_t, nBonusType, version >= EPIC_4_1) _(simple)(int8_t, nBonusPercent, version >= EPIC_4_1) \
