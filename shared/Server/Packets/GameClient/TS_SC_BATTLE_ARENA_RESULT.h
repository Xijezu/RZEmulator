...
#define TS_ARENA_MVP_DEF(_) _(string)(name, 19)
CREATE_STRUCT(TS_ARENA_MVP);

#define TS_SC_BATTLE_ARENA_RESULT_DEF(_) \
    _(simple)(TS_ARENA_END_TYPE, eEndType) _(simple)(TS_ARENA_REWARD_TYPE, eRewardType) _(simple)(int32_t, nWinnerTeamNo) _(count)(int8_t, MVPs) _(dynarray)(TS_ARENA_MVP, MVPs)
