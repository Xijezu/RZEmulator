...
#define TS_CS_GROUP_FINDER_LIST_DEF(_)                                                                               \
    _(simple)                                                                                                        \
    (int32_t, flag) _(simple)(int32_t, page_num) /* only with GFRT_List */                                           \
        _(simple)(int32_t, index) _(simple)(uint32_t, requested_group_id) /* only with GFRT_Detail and GFRT_Apply */ \
        ...
        _(simple)(int16_t, unknown3) _(simple)(uint16_t, max_player_number) /* only with GFRT_Add */                 \
