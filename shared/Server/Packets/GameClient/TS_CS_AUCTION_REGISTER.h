...
#define TS_CS_AUCTION_REGISTER_DEF(_) \
    _(simple)(uint32_t, item_handle) _(simple)(int32_t, item_count) _(simple)(int64_t, start_price) _(simple)(int64_t, instant_purchase_price) _(simple)(int8_t, duration_type)
