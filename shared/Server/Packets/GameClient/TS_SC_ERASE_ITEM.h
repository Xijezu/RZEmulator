...
#define TS_ERASE_ITEM_INFO_RESULT_DEF(_) _(simple)(uint32_t, item_handle) _(simple)(int64_t, count)

CREATE_STRUCT(TS_ERASE_ITEM_INFO_RESULT);

#define TS_SC_ERASE_ITEM_DEF(_) _(count)(int8_t, erased_items) _(dynarray)(TS_ERASE_ITEM_INFO_RESULT, erased_items)
