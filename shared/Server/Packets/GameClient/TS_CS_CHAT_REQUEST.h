...
#define TS_CS_CHAT_REQUEST_DEF(_) _(string)(szTarget, 21) _(simple)(int8_t, request_id) _(count)(uint8_t, message) _(simple)(uint8_t, type) _(dynstring)(message, false)
