...
#define TS_BOOTH_NAME_DEF(_) _(simple)(uint32_t, handle) _(string)(name, 49)
CREATE_STRUCT(TS_BOOTH_NAME);

#define TS_SC_GET_BOOTHS_NAME_DEF(_) _(count)(int32_t, booths) _(dynarray)(TS_BOOTH_NAME, booths)
