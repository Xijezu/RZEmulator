...
inline uint32_t address_to_uint(boost::asio::ip::address_v4 const &address) { return address.to_uint(); }
...
inline uint32_t address_to_uint(boost::asio::ip::address_v4 const &address) { return address.to_ulong(); }
#endif
} // namespace Net
} // namespace NGemity